...
//
//     final detailedPcGameModel = detailedPcGameModelFromJson(jsonString);

import 'dart:convert';

class DetailedPcGameModel {
  DetailedPcGameModel({
    required this.id,
    required this.title,
  ...
  factory DetailedPcGameModel.fromRawJson(String str) =>
      DetailedPcGameModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory DetailedPcGameModel.fromJson(Map<String, dynamic> json) =>
      DetailedPcGameModel(
        id: json["id"],
        title: json["title"],
