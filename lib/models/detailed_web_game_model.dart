...
//
//     final detailedWebGameModel = detailedWebGameModelFromJson(jsonString);

import 'dart:convert';

class DetailedWebGameModel {
  DetailedWebGameModel({
    required this.id,
    required this.title,
  ...
  factory DetailedWebGameModel.fromRawJson(String str) =>
      DetailedWebGameModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory DetailedWebGameModel.fromJson(Map<String, dynamic> json) =>
      DetailedWebGameModel(
        id: json["id"],
        title: json["title"],
